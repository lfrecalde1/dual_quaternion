...
/* quadrotor_constr_h_fun_jac_uxt_zt:(i0[13],i1[4],i2[],i3[17])->(o0,o1[17x1,4nz],o2[1x0]) */
static int casadi_f0(const casadi_real** arg, casadi_real** res, casadi_int* iw, casadi_real* w, int mem) {
  casadi_int i;
  casadi_real *rr, *ss;
  casadi_real w0, w1, w2, w3, w4, w5, w6, w7, w8, w9, w10, w11, w12, *w13=w+13, *w14=w+26, *w15=w+30;
  /* #0: @0 = input[0][0] */
  w0 = arg[0] ? arg[0][0] : 0;
  /* #1: @1 = input[0][1] */
  w1 = arg[0] ? arg[0][1] : 0;
  ...
  *rr++ = w12;
  ...
  /* #20: (@13[6:10] += @14) */
  for (rr=w13+6, ss=w14; rr!=w13+10; rr+=1) *rr += *ss++;
  /* #21: {NULL, NULL, NULL, NULL, NULL, NULL, @0, @1, @2, @3, NULL, NULL, NULL} = vertsplit(@13) */
  w0 = w13[6];
  w1 = w13[7];
  w2 = w13[8];
  w3 = w13[9];
  /* #22: (@15[0] = @0) */
  for (rr=w15+0, ss=(&w0); rr!=w15+1; rr+=1) *rr = *ss++;
  /* #23: (@15[1] = @1) */
  for (rr=w15+1, ss=(&w1); rr!=w15+2; rr+=1) *rr = *ss++;
  /* #24: (@15[2] = @2) */
  for (rr=w15+2, ss=(&w2); rr!=w15+3; rr+=1) *rr = *ss++;
  /* #25: (@15[3] = @3) */
  for (rr=w15+3, ss=(&w3); rr!=w15+4; rr+=1) *rr = *ss++;
  /* #26: output[1][0] = @15 */
