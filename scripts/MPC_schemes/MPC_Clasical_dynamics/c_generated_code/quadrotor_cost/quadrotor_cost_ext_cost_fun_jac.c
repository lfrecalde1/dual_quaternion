...
static int casadi_f0(const casadi_real** arg, casadi_real** res, casadi_int* iw, casadi_real* w, int mem) {
  ...
  casadi_real w0, *w1=w+5, w2, w3, w4, w5, w6, w7, w8, w9, w10, w11, w12, w13, w14, w15, w16, w17, w18, *w19=w+25, *w20=w+42, *w21=w+45, *w22=w+58, *w23=w+61, *w24=w+70, *w25=w+74, *w26=w+78, *w27=w+82, *w28=w+98, *w29=w+102, *w30=w+106, *w31=w+110, *w32=w+114, *w33=w+118, *w34=w+134, *w35=w+150, *w36=w+153, *w37=w+156;
  /* #0: @0 = 0 */
  w0 = 0.;
  /* #1: @1 = zeros(1x3) */
  casadi_clear(w1, 3);
  ...
  *rr++ = w8;
  ...
  /* #116: @29 = mac(@25,@34,@29) */
  for (i=0, rr=w29; i<4; ++i) for (j=0; j<1; ++j, ++rr) for (k=0, ss=w25+j, tt=w34+i*4; k<4; ++k) *rr += ss[k*1]**tt++;
  /* #117: @29 = @29' */
  /* #118: @24 = (@24+@29) */
  ...
  /* #155: {@4, @11, @10, @3, @2, @0, @5, @8, @6, @9, @7, @12, @13} = vertsplit(@21) */
  w4 = w21[0];
  w11 = w21[1];
  w10 = w21[2];
  w3 = w21[3];
