...
static int casadi_f0(const casadi_real** arg, casadi_real** res, casadi_int* iw, casadi_real* w, int mem) {
  ...
  casadi_real w0, *w1=w+111, w2, w3, w4, w5, w6, w7, w8, w9, w10, w11, w12, w13, w14, w15, w16, w17, w18, *w19=w+131, *w20=w+148, *w21=w+151, *w22=w+164, *w23=w+167, *w24=w+176, *w25=w+180, *w26=w+184, *w27=w+188, *w28=w+204, *w29=w+208, *w30=w+212, *w31=w+216, *w32=w+220, *w33=w+236, *w34=w+252, *w35=w+255, *w36=w+258, *w37=w+261, w39, *w40=w+265;
  /* #0: @0 = 0 */
  w0 = 0.;
  /* #1: @1 = zeros(1x3) */
  casadi_clear(w1, 3);
  ...
  *rr++ = w18;
  ...
  /* #140: @21 = zeros(13x1) */
  casadi_clear(w21, 13);
  /* #141: @38 = zeros(3x1,0nz) */
  /* #142: @36 = (2.*@36) */
  for (i=0, rr=w36, cs=w36; i<3; ++i) *rr++ = (2.* *cs++ );
  /* #143: {@24, @37} = adj1_f_rot_inv(@28, @35, @38, @36) */
  arg1[0]=w28;
  arg1[1]=w35;
  arg1[2]=0;
  arg1[3]=w36;
  ...
  w39 = (- w39 );
  /* #180: (@28[0] += @39) */
  for (rr=w28+0, ss=(&w39); rr!=w28+1; rr+=1) *rr += *ss++;
  /* #181: @15 = (@15/@11) */
  w15 /= w11;
  /* #182: @15 = (@15*@3) */
  w15 *= w3;
  ...
  /* #207: {@15, @11, @10, @16, @8, @9, @4, @18, @2, @3, @39, @5, @7} = vertsplit(@21) */
  w15 = w21[0];
  w11 = w21[1];
  w10 = w21[2];
  w16 = w21[3];
