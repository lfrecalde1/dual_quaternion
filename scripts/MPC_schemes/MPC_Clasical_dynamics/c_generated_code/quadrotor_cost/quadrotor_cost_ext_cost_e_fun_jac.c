...
static int casadi_f0(const casadi_real** arg, casadi_real** res, casadi_int* iw, casadi_real* w, int mem) {
  ...
  casadi_real w0, *w1=w+111, w2, w3, w4, w5, w6, w7, w8, w9, w10, w11, w12, w13, w14, w15, w16, w17, w18, *w19=w+131, *w20=w+148, *w21=w+151, *w22=w+164, *w23=w+167, *w24=w+176, *w25=w+179, *w26=w+182, *w27=w+191, *w28=w+194, *w29=w+198, *w30=w+201, *w32=w+204, *w33=w+208, w34, w35, w36, w37, w38;
  /* #0: @0 = 0 */
  w0 = 0.;
  /* #1: @1 = zeros(1x3) */
  casadi_clear(w1, 3);
  ...
  *rr++ = w13;
  ...
  /* #144: @1 = mac(@25,@33,@1) */
  for (i=0, rr=w1; i<3; ++i) for (j=0; j<1; ++j, ++rr) for (k=0, ss=w25+j, tt=w33+i*3; k<3; ++k) *rr += ss[k*1]**tt++;
  /* #145: @1 = @1' */
  /* #146: @22 = (@22+@1) */
