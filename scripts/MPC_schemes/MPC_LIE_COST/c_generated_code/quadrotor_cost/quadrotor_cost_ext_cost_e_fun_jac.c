...
static int casadi_f0(const casadi_real** arg, casadi_real** res, casadi_int* iw, casadi_real* w, int mem) {
  ...
  *rr++ = w45;
  ...
  /* #191: {NULL, @0, @1, @3, NULL, @38, @40, @42} = vertsplit(@2) */
  w0 = w2[1];
  w1 = w2[2];
  w3 = w2[3];
  w38 = w2[5];
  ...
  w38 = (- w38 );
  /* #205: (@48[1] += @38) */
  for (rr=w48+1, ss=(&w38); rr!=w48+2; rr+=1) *rr += *ss++;
  /* #206: (@48[0] += @39) */
  ...
  w38 = (- w38 );
  /* #218: (@48[6] += @38) */
  for (rr=w48+6, ss=(&w38); rr!=w48+7; rr+=1) *rr += *ss++;
  /* #219: (@48[7] += @39) */
  for (rr=w48+7, ss=(&w39); rr!=w48+8; rr+=1) *rr += *ss++;
  /* #220: @13 = @13' */
  /* #221: {@39, @38, @41, @40} = horzsplit(@13) */
  w39 = w13[0];
  w38 = w13[1];
  w41 = w13[2];
  w40 = w13[3];
  ...
  /* #225: (@48[7] += @38) */
  for (rr=w48+7, ss=(&w38); rr!=w48+8; rr+=1) *rr += *ss++;
  /* #226: (@48[6] += @39) */
  for (rr=w48+6, ss=(&w39); rr!=w48+7; rr+=1) *rr += *ss++;
  /* #227: @16 = @16' */
  /* #228: {@39, @38, @41, @40} = horzsplit(@16) */
  w39 = w16[0];
  w38 = w16[1];
  w41 = w16[2];
  w40 = w16[3];
  ...
  /* #232: (@48[4] += @38) */
  for (rr=w48+4, ss=(&w38); rr!=w48+5; rr+=1) *rr += *ss++;
  /* #233: (@48[5] += @39) */
  for (rr=w48+5, ss=(&w39); rr!=w48+6; rr+=1) *rr += *ss++;
  /* #234: @17 = @17' */
  /* #235: {@39, @38, @41, @40} = horzsplit(@17) */
  w39 = w17[0];
  w38 = w17[1];
  w41 = w17[2];
  w40 = w17[3];
  ...
  w38 = (- w38 );
  /* #241: (@48[5] += @38) */
  for (rr=w48+5, ss=(&w38); rr!=w48+6; rr+=1) *rr += *ss++;
  /* #242: (@48[4] += @39) */
  ...
  w38 = (- w38 );
  /* #266: (@48[0] += @38) */
  for (rr=w48+0, ss=(&w38); rr!=w48+1; rr+=1) *rr += *ss++;
  /* #267: @31 = (@31/@9) */
  w31 /= w9;
  /* #268: @31 = (@31*@1) */
  w31 *= w1;
