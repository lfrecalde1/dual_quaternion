...
static int casadi_f0(const casadi_real** arg, casadi_real** res, casadi_int* iw, casadi_real* w, int mem) {
  ...
  casadi_real w0, *w1=w+5, w2, w3, w4, w5, w6, w7, w8, w9, w10, w11, w12, w13, w14, w15, w16, w17, w18, *w19=w+25, *w20=w+42, *w21=w+45, *w22=w+58, *w23=w+61, *w24=w+70, *w25=w+74, *w26=w+78, *w27=w+82, *w28=w+98, *w29=w+101, *w30=w+105, *w31=w+109, *w32=w+113, *w33=w+117, *w34=w+133, *w35=w+149, *w36=w+152, *w37=w+155, *w38=w+164, *w39=w+167, *w40=w+170, w41;
  /* #0: @0 = 0 */
  w0 = 0.;
  /* #1: @1 = zeros(1x3) */
  casadi_clear(w1, 3);
  ...
  *rr++ = w17;
  ...
  w18 = 2.0000000000000001e-01;
  /* #163: @39 = (@18*@36) */
  for (i=0, rr=w39, cs=w36; i<3; ++i) (*rr++)  = (w18*(*cs++));
  /* #164: @36 = @36' */
  /* #165: @36 = (@18*@36) */
  ...
  /* #178: @39 = mac(@35,@40,@39) */
  for (i=0, rr=w39; i<3; ++i) for (j=0; j<1; ++j, ++rr) for (k=0, ss=w35+j, tt=w40+i*3; k<3; ++k) *rr += ss[k*1]**tt++;
  /* #179: @39 = @39' */
  /* #180: @22 = (@22+@39) */
  for (i=0, rr=w22, cs=w39; i<3; ++i) (*rr++) += (*cs++);
  /* #181: {@18, @3, @2} = vertsplit(@22) */
  w18 = w22[0];
  w3 = w22[1];
  w2 = w22[2];
  /* #182: @0 = (@2/@11) */
  ...
  /* #227: @28 = mac(@20,@40,@28) */
  for (i=0, rr=w28; i<3; ++i) for (j=0; j<1; ++j, ++rr) for (k=0, ss=w20+j, tt=w40+i*3; k<3; ++k) *rr += ss[k*1]**tt++;
  /* #228: @28 = @28' */
  /* #229: @1 = (@1+@28) */
  ...
  /* #232: {@14, @11, @10, @15, @8, @9, @18, @17, @2, @3, @41, @4, @6} = vertsplit(@21) */
  w14 = w21[0];
  w11 = w21[1];
  w10 = w21[2];
  w15 = w21[3];
