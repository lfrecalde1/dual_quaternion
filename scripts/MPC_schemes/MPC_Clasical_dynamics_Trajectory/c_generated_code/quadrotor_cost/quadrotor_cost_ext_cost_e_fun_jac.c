...
static int casadi_f0(const casadi_real** arg, casadi_real** res, casadi_int* iw, casadi_real* w, int mem) {
  ...
  casadi_real w0, *w1=w+2, w2, w3, w4, w5, w6, w7, w8, w9, w10, w11, w12, w13, w14, w15, w16, w17, w18, *w19=w+22, *w20=w+39, *w21=w+42, *w22=w+55, *w23=w+58, *w24=w+67, *w25=w+70, *w26=w+73, *w27=w+82, *w28=w+85, *w29=w+88, w30, w31, w32, w33, w34;
  /* #0: @0 = 0 */
  w0 = 0.;
  /* #1: @1 = zeros(1x3) */
  casadi_clear(w1, 3);
  ...
  *rr++ = w13;
  ...
  w0 = 2.0000000000000001e-01;
  /* #131: @28 = (@0*@25) */
  for (i=0, rr=w28, cs=w25; i<3; ++i) (*rr++)  = (w0*(*cs++));
  /* #132: @25 = @25' */
  /* #133: @25 = (@0*@25) */
  ...
  /* #146: {@0, @2, @15, @14, @12, @7, @16, @17, @18, @30, @31, @32, @33} = vertsplit(@21) */
  w0 = w21[0];
  w2 = w21[1];
  w15 = w21[2];
  w14 = w21[3];
  ...
  /* #157: @1 = mac(@28,@29,@1) */
  for (i=0, rr=w1; i<3; ++i) for (j=0; j<1; ++j, ++rr) for (k=0, ss=w28+j, tt=w29+i*3; k<3; ++k) *rr += ss[k*1]**tt++;
  /* #158: @1 = @1' */
  /* #159: @22 = (@22+@1) */
  for (i=0, rr=w22, cs=w1; i<3; ++i) (*rr++) += (*cs++);
  /* #160: @1 = (@22/@5) */
  for (i=0, rr=w1, cr=w22; i<3; ++i) (*rr++)  = ((*cr++)/w5);
  /* #161: {@7, @12, @14} = vertsplit(@1) */
  w7 = w1[0];
  w12 = w1[1];
  w14 = w1[2];
  /* #162: @15 = (@3*@12) */
