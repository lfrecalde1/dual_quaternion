...
static int casadi_f0(const casadi_real** arg, casadi_real** res, casadi_int* iw, casadi_real* w, int mem) {
  ...
  casadi_real w0, *w1=w+5, w2, w3, w4, w5, w6, w7, w8, w9, w10, w11, w12, w13, w14, w15, w16, w17, w18, *w19=w+25, *w20=w+42, *w21=w+45, *w22=w+58, *w23=w+61, *w24=w+70, *w25=w+73, *w26=w+77, *w27=w+81, *w28=w+85, *w29=w+89, *w30=w+93, *w31=w+109, *w32=w+125, *w33=w+128, *w34=w+131, *w35=w+140, *w36=w+143, *w37=w+146, w38;
  /* #0: @0 = 0 */
  w0 = 0.;
  /* #1: @1 = zeros(1x3) */
  casadi_clear(w1, 3);
  ...
  *rr++ = w17;
  ...
  w0 = 2.0000000000000001e-01;
  /* #128: @36 = (@0*@33) */
  for (i=0, rr=w36, cs=w33; i<3; ++i) (*rr++)  = (w0*(*cs++));
  /* #129: @33 = @33' */
  /* #130: @33 = (@0*@33) */
  ...
  /* #192: @24 = mac(@20,@37,@24) */
  for (i=0, rr=w24; i<3; ++i) for (j=0; j<1; ++j, ++rr) for (k=0, ss=w20+j, tt=w37+i*3; k<3; ++k) *rr += ss[k*1]**tt++;
  /* #193: @24 = @24' */
  /* #194: @1 = (@1+@24) */
