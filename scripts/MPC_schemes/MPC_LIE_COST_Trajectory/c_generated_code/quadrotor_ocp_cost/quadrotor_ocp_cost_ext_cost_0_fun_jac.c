...
static int casadi_f0(const casadi_real** arg, casadi_real** res, casadi_int* iw, casadi_real* w, int mem) {
  ...
  casadi_real w0, w1, *w2=w+10, *w3=w+18, *w4=w+26, *w5=w+34, w6, w7, w8, w9, *w10=w+56, w11, w12, *w13=w+62, *w14=w+66, *w15=w+70, *w16=w+74, *w17=w+90, *w18=w+106, *w19=w+138, *w20=w+170, *w21=w+186, *w22=w+218, *w23=w+282, w24, w25, w26, w27, w28, w29, w30, w31, *w32=w+354, *w33=w+368, *w34=w+376;
  /* #0: @0 = 10 */
  w0 = 10.;
  /* #1: @1 = 0 */
  w1 = 0.;
  ...
  *rr++ = w7;
  ...
  /* #136: @34 = @23' */
  for (i=0, rr=w34, cs=w23; i<8; ++i) for (j=0; j<8; ++j) rr[i+j*8] = *cs++;
  /* #137: @33 = mac(@3,@34,@33) */
  for (i=0, rr=w33; i<8; ++i) for (j=0; j<1; ++j, ++rr) for (k=0, ss=w3+j, tt=w34+i*8; k<8; ++k) *rr += ss[k*1]**tt++;
  /* #138: @33 = @33' */
  /* #139: @2 = (@2+@33) */
  ...
  /* #143: {@6, @12, @1, @0, @9, @7, @11, @8, @24, @25, @26, @27, @28, @29} = vertsplit(@32) */
  w6 = w32[0];
  w12 = w32[1];
  w1 = w32[2];
  w0 = w32[3];
