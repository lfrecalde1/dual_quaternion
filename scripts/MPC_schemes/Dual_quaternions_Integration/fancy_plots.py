...
def plot_dual_real_reference(fig11, ax11, ax21, ax31, ax41, F, M, F_ref, M_ref, t, name, path):
        t = t[0:M.shape[1]]
        ax11.set_xlim((t[0], t[-1]))
        ax21.set_xlim((t[0], t[-1]))
        ax31.set_xlim((t[0], t[-1]))
        ...
        state_1_e, = ax11.plot(t[0:t.shape[0]], F[0:t.shape[0]],
                    color='#C43C29', lw=1.0, ls="-")

        state_1_e_ref, = ax11.plot(t[0:t.shape[0]], F_ref[0:t.shape[0]],
                    color='#C43C29', lw=1.0, ls="--")
