...
static const casadi_int casadi_s5[8] = {14, 1, 0, 4, 6, 7, 8, 9};
...
/* quadrotor_constr_h_fun_jac_uxt_zt:(i0[8],i1[6],i2[],i3[14])->(o0,o1[14x1,4nz],o2[1x0]) */
static int casadi_f0(const casadi_real** arg, casadi_real** res, casadi_int* iw, casadi_real* w, int mem) {
  casadi_int i;
  casadi_real **res1=res+3, *rr, *ss;
  const casadi_real **arg1=arg+4;
  casadi_real w0, w1, w2, w3, w4, w5, w6, w7, *w8=w+16, *w9=w+24, *w10=w+28, *w12=w+32;
  /* #0: @0 = input[0][0] */
  w0 = arg[0] ? arg[0][0] : 0;
  /* #1: @1 = input[0][1] */
  w1 = arg[0] ? arg[0][1] : 0;
  ...
  *rr++ = w7;
  ...
  /* #11: output[0][0] = @0 */
  if (res[0]) res[0][0] = w0;
  /* #12: @10 = zeros(14x1,4nz) */
  casadi_clear(w10, 4);
  /* #13: @11 = zeros(4x1,0nz) */
  /* #14: @9 = (@9/@0) */
  for (i=0, rr=w9; i<4; ++i) (*rr++) /= w0;
  /* #15: @12 = adj1_f_quat(@8, @11, @9) */
  arg1[0]=w8;
  arg1[1]=0;
  arg1[2]=w9;
  res1[0]=w12;
  if (casadi_f2(arg1, res1, iw, w, 0)) return 1;
  /* #16: {@0, @1, @2, @3, NULL, NULL, NULL, NULL} = vertsplit(@12) */
  w0 = w12[0];
  w1 = w12[1];
  w2 = w12[2];
  w3 = w12[3];
  /* #17: (@10[0] = @0) */
  for (rr=w10+0, ss=(&w0); rr!=w10+1; rr+=1) *rr = *ss++;
  /* #18: (@10[1] = @1) */
  for (rr=w10+1, ss=(&w1); rr!=w10+2; rr+=1) *rr = *ss++;
  /* #19: (@10[2] = @2) */
  for (rr=w10+2, ss=(&w2); rr!=w10+3; rr+=1) *rr = *ss++;
  /* #20: (@10[3] = @3) */
  for (rr=w10+3, ss=(&w3); rr!=w10+4; rr+=1) *rr = *ss++;
  /* #21: output[1][0] = @10 */
