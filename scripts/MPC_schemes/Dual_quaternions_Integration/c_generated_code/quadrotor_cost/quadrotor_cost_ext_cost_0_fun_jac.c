...
static int casadi_f0(const casadi_real** arg, casadi_real** res, casadi_int* iw, casadi_real* w, int mem) {
  ...
  *rr++ = w46;
  ...
  /* #182: @50 = @43' */
  for (i=0, rr=w50, cs=w43; i<6; ++i) for (j=0; j<6; ++j) rr[i+j*6] = *cs++;
  /* #183: @42 = mac(@41,@50,@42) */
  for (i=0, rr=w42; i<6; ++i) for (j=0; j<1; ++j, ++rr) for (k=0, ss=w41+j, tt=w50+i*6; k<6; ++k) *rr += ss[k*1]**tt++;
  /* #184: @42 = @42' */
  /* #185: @2 = (@2+@42) */
  for (i=0, rr=w2, cs=w42; i<6; ++i) (*rr++) += (*cs++);
  /* #186: {@44, @40, @37, @35, @1, @0} = vertsplit(@2) */
  w44 = w2[0];
  w40 = w2[1];
  w37 = w2[2];
  w35 = w2[3];
  ...
  /* #279: {@30, @13, @7, @31, @8, @9, @44, @33} = vertsplit(@5) */
  w30 = w5[0];
  w13 = w5[1];
  w7 = w5[2];
  w31 = w5[3];
