...
def main(robot):
    ...
    plot_states_quaternion(fig11, ax11, ax12, ax13, ax14, x[4:8, :], xd[3:7, :], t, "Quaternion Results Based On LieAlgebra Cost "+ str(initial), folder_path)

    fig21, ax21, ax22, ax23 = fancy_plots_3()
    plot_states_position(fig21, ax21, ax22, ax23, x[1:4, :], xd[0:3, :], t, "Position Results Based On LieAlgebra Cost "+ str(initial), folder_path)

    fig31, ax31  = fancy_plots_1()
    plot_cost_orientation(fig31, ax31, orientation_cost, t, "Cost Ori Based On LieAlgebra Cost "+ str(initial), folder_path)

    fig41, ax42  = fancy_plots_1()
    plot_cost_translation(fig41, ax42, translation_cost, t, "Cost Translation Based On LieAlgebra Cost "+ str(initial), folder_path)

    # Control Actions
    fig51, ax51, ax52, ax53, ax54 = fancy_plots_4()
    plot_control_actions_joints(fig51, ax51, ax52, ax53, ax54, qp_c, t, "Control Actions of the System Based On LieAlgebra Cost "+ str(initial), folder_path)
    return None
