...
/* quadrotor_cost_ext_cost_0_fun:(i0[14],i1[6],i2[],i3[14])->(o0) */
static int casadi_f0(const casadi_real** arg, casadi_real** res, casadi_int* iw, casadi_real* w, int mem) {
  casadi_int i, j, k;
  casadi_real *rr, *ss, *tt;
  const casadi_real *cs;
  casadi_real w0, w1, *w2=w+10, w3, *w4=w+17, *w5=w+20, *w6=w+28, w7, w8, w9, w10, *w11=w+46, w12, w13, *w14=w+52, *w15=w+56, *w16=w+60, *w17=w+64, *w18=w+80, *w19=w+96, *w20=w+128, *w21=w+160, *w22=w+176, *w23=w+208, *w24=w+272, w25, w26, w27, w28, w29, w30, w31, w32, *w33=w+344, *w34=w+358, *w35=w+366, *w36=w+369, *w37=w+373, *w38=w+379, *w39=w+385;
  /* #0: @0 = 10 */
  w0 = 10.;
  /* #1: @1 = 0 */
  w1 = 0.;
  ...
  *rr++ = w12;
  ...
  casadi_clear(w2, 6);
  /* #164: @37 = @6[8:14] */
  for (rr=w37, ss=w6+8; ss!=w6+14; ss+=1) *rr++ = *ss;
  /* #165: @10 = input[1][0] */
  w10 = arg[1] ? arg[1][0] : 0;
  /* #166: @8 = input[1][1] */
  w8 = arg[1] ? arg[1][1] : 0;
  ...
  *rr++ = w9;
  ...
  w10 = 2.;
  /* #176: (@39[0] = @10) */
  for (rr=w39+0, ss=(&w10); rr!=w39+1; rr+=1) *rr = *ss++;
  /* #177: @10 = 2 */
  w10 = 2.;
  /* #178: (@39[7] = @10) */
  for (rr=w39+7, ss=(&w10); rr!=w39+8; rr+=1) *rr = *ss++;
  /* #179: @10 = 2 */
  w10 = 2.;
  /* #180: (@39[14] = @10) */
  for (rr=w39+14, ss=(&w10); rr!=w39+15; rr+=1) *rr = *ss++;
  /* #181: @10 = 2 */
  w10 = 2.;
  /* #182: (@39[21] = @10) */
  for (rr=w39+21, ss=(&w10); rr!=w39+22; rr+=1) *rr = *ss++;
  /* #183: @10 = 2 */
  w10 = 2.;
  /* #184: (@39[28] = @10) */
  for (rr=w39+28, ss=(&w10); rr!=w39+29; rr+=1) *rr = *ss++;
  /* #185: @10 = 2 */
  w10 = 2.;
  /* #186: (@39[35] = @10) */
  for (rr=w39+35, ss=(&w10); rr!=w39+36; rr+=1) *rr = *ss++;
  /* #187: @2 = mac(@38,@39,@2) */
  for (i=0, rr=w2; i<6; ++i) for (j=0; j<1; ++j, ++rr) for (k=0, ss=w38+j, tt=w39+i*6; k<6; ++k) *rr += ss[k*1]**tt++;
  /* #188: @3 = mac(@2,@37,@3) */
  for (i=0, rr=(&w3); i<1; ++i) for (j=0; j<1; ++j, ++rr) for (k=0, ss=w2+j, tt=w37+i*6; k<6; ++k) *rr += ss[k*1]**tt++;
  /* #189: @1 = (@1*@3) */
  w1 *= w3;
  /* #190: @0 = (@0+@1) */
  w0 += w1;
