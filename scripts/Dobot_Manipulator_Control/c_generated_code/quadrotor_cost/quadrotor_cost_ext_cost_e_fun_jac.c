...
static int casadi_f0(const casadi_real** arg, casadi_real** res, casadi_int* iw, casadi_real* w, int mem) {
  ...
  *rr++ = w40;
  ...
  /* #178: {@0, @1, @35, @37, @40, @45} = vertsplit(@2) */
  w0 = w2[0];
  w1 = w2[1];
  w35 = w2[2];
  w37 = w2[3];
  ...
  w40 = (- w40 );
  /* #188: (@33[3] += @40) */
  for (rr=w33+3, ss=(&w40); rr!=w33+4; rr+=1) *rr += *ss++;
  /* #189: @36 = (-@36) */
  w36 = (- w36 );
  /* #190: (@33[2] += @36) */
  ...
  w37 = (- w37 );
  /* #192: (@33[1] += @37) */
  for (rr=w33+1, ss=(&w37); rr!=w33+2; rr+=1) *rr += *ss++;
  /* #193: (@33[0] += @32) */
  ...
  /* #212: (@33[7] += @37) */
  for (rr=w33+7, ss=(&w37); rr!=w33+8; rr+=1) *rr += *ss++;
  /* #213: (@33[6] += @32) */
  for (rr=w33+6, ss=(&w32); rr!=w33+7; rr+=1) *rr += *ss++;
  /* #214: @14 = @14' */
  /* #215: {@32, @37, @36, @40} = horzsplit(@14) */
  w32 = w14[0];
  w37 = w14[1];
  w36 = w14[2];
  w40 = w14[3];
  ...
  /* #219: (@33[4] += @37) */
  for (rr=w33+4, ss=(&w37); rr!=w33+5; rr+=1) *rr += *ss++;
  /* #220: (@33[5] += @32) */
  for (rr=w33+5, ss=(&w32); rr!=w33+6; rr+=1) *rr += *ss++;
  /* #221: @15 = @15' */
  /* #222: {@32, @37, @36, @40} = horzsplit(@15) */
  w32 = w15[0];
  w37 = w15[1];
  w36 = w15[2];
  w40 = w15[3];
  ...
  w37 = (- w37 );
  /* #228: (@33[5] += @37) */
  for (rr=w33+5, ss=(&w37); rr!=w33+6; rr+=1) *rr += *ss++;
  /* #229: (@33[4] += @32) */
  ...
  w10 *= w32;
  /* #232: (@33[3] += @10) */
  for (rr=w33+3, ss=(&w10); rr!=w33+4; rr+=1) *rr += *ss++;
  /* #233: @10 = (@1/@13) */
  w10  = (w1/w13);
  /* #234: @26 = (@26*@10) */
  w26 *= w10;
  /* #235: (@33[2] += @26) */
  for (rr=w33+2, ss=(&w26); rr!=w33+3; rr+=1) *rr += *ss++;
  /* #236: @26 = (@0/@13) */
  w26  = (w0/w13);
  /* #237: @8 = (@8*@26) */
  w8 *= w26;
  ...
  w37 = (- w37 );
  /* #254: (@33[0] += @37) */
  for (rr=w33+0, ss=(&w37); rr!=w33+1; rr+=1) *rr += *ss++;
  /* #255: @28 = (@28/@13) */
  w28 /= w13;
  /* #256: @28 = (@28*@1) */
  w28 *= w1;
