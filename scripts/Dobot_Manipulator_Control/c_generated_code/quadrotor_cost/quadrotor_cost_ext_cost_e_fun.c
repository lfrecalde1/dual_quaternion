...
/* quadrotor_cost_ext_cost_e_fun:(i0[14],i1[],i2[],i3[14])->(o0) */
static int casadi_f0(const casadi_real** arg, casadi_real** res, casadi_int* iw, casadi_real* w, int mem) {
  casadi_int i, j, k;
  casadi_real *rr, *ss, *tt;
  const casadi_real *cs;
  casadi_real w0, w1, *w2=w+10, w3, *w4=w+17, *w5=w+20, *w6=w+28, w7, w8, w9, w10, *w11=w+46, w12, w13, *w14=w+52, *w15=w+56, *w16=w+60, *w17=w+64, *w18=w+80, *w19=w+96, *w20=w+128, *w21=w+160, *w22=w+176, *w23=w+208, *w24=w+272, w25, w26, w27, w28, w29, w30, w31, w32, *w33=w+344, *w34=w+352, *w35=w+355, *w36=w+359, *w37=w+365, *w38=w+371;
  /* #0: @0 = 10 */
  w0 = 10.;
  /* #1: @1 = 0 */
  w1 = 0.;
  ...
  *rr++ = w12;
  ...
  w3 = 1.0000000000000001e-01;
  /* #149: (@38[7] = @3) */
  for (rr=w38+7, ss=(&w3); rr!=w38+8; rr+=1) *rr = *ss++;
  /* #150: @3 = 0.1 */
  w3 = 1.0000000000000001e-01;
  /* #151: (@38[14] = @3) */
  for (rr=w38+14, ss=(&w3); rr!=w38+15; rr+=1) *rr = *ss++;
  /* #152: @3 = 2 */
  w3 = 2.;
  /* #153: (@38[21] = @3) */
  for (rr=w38+21, ss=(&w3); rr!=w38+22; rr+=1) *rr = *ss++;
  /* #154: @3 = 2 */
  w3 = 2.;
  /* #155: (@38[28] = @3) */
  for (rr=w38+28, ss=(&w3); rr!=w38+29; rr+=1) *rr = *ss++;
  /* #156: @3 = 2 */
  w3 = 2.;
  /* #157: (@38[35] = @3) */
  for (rr=w38+35, ss=(&w3); rr!=w38+36; rr+=1) *rr = *ss++;
  /* #158: @2 = mac(@37,@38,@2) */
  for (i=0, rr=w2; i<6; ++i) for (j=0; j<1; ++j, ++rr) for (k=0, ss=w37+j, tt=w38+i*6; k<6; ++k) *rr += ss[k*1]**tt++;
  /* #159: @1 = mac(@2,@36,@1) */
  for (i=0, rr=(&w1); i<1; ++i) for (j=0; j<1; ++j, ++rr) for (k=0, ss=w2+j, tt=w36+i*6; k<6; ++k) *rr += ss[k*1]**tt++;
  /* #160: @0 = (@0*@1) */
  w0 *= w1;
  /* #161: output[0][0] = @0 */
  if (res[0]) res[0][0] = w0;
