...
static const casadi_int casadi_s5[8] = {10, 1, 0, 4, 3, 4, 5, 6};
static const casadi_int casadi_s6[3] = {1, 0, 0};

/* quadrotor_constr_h_fun_jac_uxt_zt:(i0[7],i1[3],i2[],i3[10])->(o0,o1[10x1,4nz],o2[1x0]) */
static int casadi_f0(const casadi_real** arg, casadi_real** res, casadi_int* iw, casadi_real* w, int mem) {
  ...
  *rr++ = w6;
  /* #8: @8 = @7[:4] */
  for (rr=w8, ss=w7+0; ss!=w7+4; ss+=1) *rr++ = *ss;
  /* #9: @0 = ||@8||_F */
  ...
  /* #14: (@7[:4] += @8) */
  for (rr=w7+0, ss=w8; rr!=w7+4; rr+=1) *rr += *ss++;
  /* #15: {@0, @1, @2, @3, NULL, NULL, NULL} = vertsplit(@7) */
  w0 = w7[0];
  w1 = w7[1];
  w2 = w7[2];
  w3 = w7[3];
