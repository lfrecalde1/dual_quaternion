...
static int casadi_f0(const casadi_real** arg, casadi_real** res, casadi_int* iw, casadi_real* w, int mem) {
  ...
  *rr++ = w37;
  ...
  /* #144: @48 = (@33*@48) */
  for (i=0, rr=w48, cs=w48; i<3; ++i) (*rr++)  = (w33*(*cs++));
  /* #145: @1 = mac(@48,@31,@1) */
  ...
  /* #173: {@42, @5, @13, @51} = horzsplit(@50) */
  casadi_copy(w50, 4, w42);
  casadi_copy(w50+4, 4, w5);
  casadi_copy(w50+8, 4, w13);
  casadi_copy(w50+12, 4, w51);
  /* #174: @51 = @51' */
  /* #175: {@0, @36, @37, @6} = horzsplit(@51) */
  w0 = w51[0];
  w36 = w51[1];
  w37 = w51[2];
  w6 = w51[3];
  ...
  /* #206: @50 = @43' */
  for (i=0, rr=w50, cs=w43; i<4; ++i) for (j=0; j<4; ++j) rr[i+j*4] = *cs++;
  /* #207: {@41, @15, @42, @5} = horzsplit(@50) */
  casadi_copy(w50, 4, w41);
  casadi_copy(w50+4, 4, w15);
  casadi_copy(w50+8, 4, w42);
  casadi_copy(w50+12, 4, w5);
  /* #208: @5 = @5' */
  /* #209: {@0, @36, @37, @6} = horzsplit(@5) */
  w0 = w5[0];
  w36 = w5[1];
  w37 = w5[2];
  w6 = w5[3];
