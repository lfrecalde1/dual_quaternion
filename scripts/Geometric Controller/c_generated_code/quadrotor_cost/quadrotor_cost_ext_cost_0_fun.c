...
static int casadi_f0(const casadi_real** arg, casadi_real** res, casadi_int* iw, casadi_real* w, int mem) {
  ...
  casadi_real w0, w1, *w2=w+6, w3, *w4=w+10, *w5=w+13, w6, w7, w8, w9, *w10=w+21, w11, w12, *w13=w+27, w14, *w15=w+32, *w16=w+36, *w17=w+40, *w18=w+56, w19, w20, w21, w22, *w23=w+76, *w24=w+83, *w25=w+86, *w26=w+95, *w27=w+99, w28, w29, w30, *w31=w+106;
  /* #0: @0 = 1000 */
  w0 = 1000.;
  /* #1: @1 = 0 */
  w1 = 0.;
  ...
  *rr++ = w19;
  ...
  /* #70: @19 = @5[1] */
  for (rr=(&w19), ss=w5+1; ss!=w5+2; ss+=1) *rr++ = *ss;
  /* #71: @14 = @5[2] */
  for (rr=(&w14), ss=w5+2; ss!=w5+3; ss+=1) *rr++ = *ss;
  /* #72: @11 = @5[3] */
  for (rr=(&w11), ss=w5+3; ss!=w5+4; ss+=1) *rr++ = *ss;
  /* #73: @15 = horzcat(@12, @19, @14, @11) */
  rr=w15;
  *rr++ = w12;
  *rr++ = w19;
  *rr++ = w14;
  ...
  *rr++ = w21;
  ...
  /* #95: @30 = input[3][9] */
  w30 = arg[3] ? arg[3][9] : 0;
  /* #96: @31 = vertcat(@6, @7, @8, @9, @12, @21, @22, @28, @29, @30) */
  rr=w31;
  *rr++ = w6;
  *rr++ = w7;
  *rr++ = w8;
  ...
  *rr++ = w30;
  /* #97: @4 = @31[4:7] */
  for (rr=w4, ss=w31+4; ss!=w31+7; ss+=1) *rr++ = *ss;
  /* #98: @15 = vertcat(@20, @4) */
  rr=w15;
  *rr++ = w20;
  ...
  *rr++ = w8;
  /* #115: @16 = @16' */
  /* #116: @20 = @13[2] */
  for (rr=(&w20), ss=w13+2; ss!=w13+3; ss+=1) *rr++ = *ss;
  /* #117: @6 = @13[3] */
  ...
  *rr++ = w8;
  /* #122: @26 = @26' */
  /* #123: @20 = @13[3] */
  for (rr=(&w20), ss=w13+3; ss!=w13+4; ss+=1) *rr++ = *ss;
  /* #124: @6 = @13[2] */
  ...
  *rr++ = w11;
  ...
  casadi_copy(w2, 3, w4);
  /* #138: @3 = mac(@4,@2,@3) */
  for (i=0, rr=(&w3); i<1; ++i) for (j=0; j<1; ++j, ++rr) for (k=0, ss=w4+j, tt=w2+i*3; k<3; ++k) *rr += ss[k*1]**tt++;
  /* #139: @1 = (@1*@3) */
  w1 *= w3;
  /* #140: @0 = (@0+@1) */
  w0 += w1;
