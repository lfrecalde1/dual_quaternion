...
def main(odom_pub_1, odom_pub_2):
    ...
    for k in range(0, t.shape[0]):
        ...
        lyapunov_dot_values[0, k] = lyapunov_dot_lie(dual_2, dual_1)@Jacobian_system@control_values
    ...
    plot_states_quaternion(fig11, ax11, ax21, ax31, ax41, Q1_data[0:4, :], Q2_data[0:4, :], t, "Quaternion Results Classic Controller")
    plt.show()


    fig12, ax12, ax22, ax32 = fancy_plots_3()
    plot_states_position(fig12, ax12, ax22, ax32, Q1_trans_data[1:4, :], Q2_trans_data[1:4, :], t, "Position of the System Classic Controller")
    plt.show()
    fig13, ax13, ax23, ax33 = fancy_plots_3()
    plot_angular_velocities(fig13, ax13, ax23, ax33, Velocities_data[0:3, :], t, "Angular velocities Body Classic Controller")
    plt.show()

    fig14, ax14, ax24, ax34 = fancy_plots_3()
    plot_linear_velocities(fig14, ax14, ax24, ax34, Velocities_data[3:6, :], t, "Linear velocities Body Classic Controller")
    plt.show()
