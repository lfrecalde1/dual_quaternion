...
static int casadi_f0(const casadi_real** arg, casadi_real** res, casadi_int* iw, casadi_real* w, int mem) {
  ...
  *rr++ = w44;
  ...
  /* #154: @48 = (@0*@47) */
  for (i=0, rr=w48, cs=w47; i<3; ++i) (*rr++)  = (w0*(*cs++));
  /* #155: @47 = @47' */
  /* #156: @47 = (@0*@47) */
  for (i=0, rr=w47, cs=w47; i<3; ++i) (*rr++)  = (w0*(*cs++));
  /* #157: @47 = @47' */
  /* #158: @48 = (@48+@47) */
  ...
  /* #179: {NULL, @0, @1, @3, NULL, @38, @43, @40} = vertsplit(@2) */
  w0 = w2[1];
  w1 = w2[2];
  w3 = w2[3];
  w38 = w2[5];
