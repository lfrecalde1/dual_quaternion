...
static int casadi_f0(const casadi_real** arg, casadi_real** res, casadi_int* iw, casadi_real* w, int mem) {
  ...
  *rr++ = w27;
  ...
  w10 = (- w14 );
  /* #109: @28 = @36[0] */
  for (rr=(&w28), ss=w36+0; ss!=w36+1; ss+=1) *rr++ = *ss;
  /* #110: @29 = (-@11) */
  w29 = (- w11 );
  /* #111: @17 = horzcat(@10, @28, @27, @29) */
  rr=w17;
  *rr++ = w10;
  *rr++ = w28;
  *rr++ = w27;
  ...
  *rr++ = w29;
  ...
  /* #132: @11 = (@11*@10) */
  w11 *= w10;
  /* #133: @36 = vertcat(@3, @4, @9, @12, @6, @15, @27, @11) */
  rr=w36;
  *rr++ = w3;
  *rr++ = w4;
  *rr++ = w9;
  ...
  *rr++ = w12;
  ...
  w1 = 0.;
  /* #154: @5 = @35[8:11] */
  for (rr=w5, ss=w35+8; ss!=w35+11; ss+=1) *rr++ = *ss;
  /* #155: @37 = @5' */
  casadi_copy(w5, 3, w37);
  /* #156: @1 = mac(@37,@5,@1) */
  for (i=0, rr=(&w1); i<1; ++i) for (j=0; j<1; ++j, ++rr) for (k=0, ss=w37+j, tt=w5+i*3; k<3; ++k) *rr += ss[k*1]**tt++;
  /* #157: @0 = (@0+@1) */
  w0 += w1;
  /* #158: @1 = 0.5 */
  ...
  /* #162: @3 = mac(@5,@37,@3) */
  for (i=0, rr=(&w3); i<1; ++i) for (j=0; j<1; ++j, ++rr) for (k=0, ss=w5+j, tt=w37+i*3; k<3; ++k) *rr += ss[k*1]**tt++;
  /* #163: @1 = (@1*@3) */
  w1 *= w3;
  /* #164: @0 = (@0+@1) */
  w0 += w1;
