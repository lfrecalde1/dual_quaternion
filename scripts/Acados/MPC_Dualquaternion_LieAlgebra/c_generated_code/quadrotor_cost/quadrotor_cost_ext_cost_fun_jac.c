...
static int casadi_f0(const casadi_real** arg, casadi_real** res, casadi_int* iw, casadi_real* w, int mem) {
  ...
  *rr++ = w40;
  ...
  /* #162: @3 = mac(@48,@47,@3) */
  for (i=0, rr=(&w3); i<1; ++i) for (j=0; j<1; ++j, ++rr) for (k=0, ss=w48+j, tt=w47+i*3; k<3; ++k) *rr += ss[k*1]**tt++;
  /* #163: @1 = (@1*@3) */
  w1 *= w3;
  /* #164: @0 = (@0+@1) */
  w0 += w1;
  ...
  /* #181: @48 = (@38*@47) */
  for (i=0, rr=w48, cs=w47; i<3; ++i) (*rr++)  = (w38*(*cs++));
  /* #182: @47 = @47' */
  /* #183: @47 = (@38*@47) */
  for (i=0, rr=w47, cs=w47; i<3; ++i) (*rr++)  = (w38*(*cs++));
  /* #184: @47 = @47' */
  /* #185: @48 = (@48+@47) */
  ...
  /* #206: {NULL, @38, @3, @1, NULL, @0, @43, @40} = vertsplit(@2) */
  w38 = w2[1];
  w3 = w2[2];
  w1 = w2[3];
  w0 = w2[5];
  ...
  /* #291: {@15, @6, @31, @9, @12, @32, @14, @27, @38, @34, @1, @3, @44, @4} = vertsplit(@35) */
  w15 = w35[0];
  w6 = w35[1];
  w31 = w35[2];
  w9 = w35[3];
